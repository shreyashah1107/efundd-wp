                ...
                <div class="sliding-tabs">
                    <div class="tabs">
                        ...
                        <?php } else { ?>
                            ...
                            <label class="tab" for="corporate-tab">Corporate</label>
                        <?php } ?>
                        <?php if ($current_slug == 'business-landing-page' || $current_slug == 'in-person-payments') { ?>
