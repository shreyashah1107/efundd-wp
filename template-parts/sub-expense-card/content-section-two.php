<section class="expense-card-content-section--two">
          ...
          <div class="row align-items-center justify-content-center justify-content-lg-start">
            <div class="col-lg-7 col-xl-6 mb-5 mb-lg-0">
              <div class="title-row mb-4">
                <h3 class="section-title section-title--xl text-anime-style-3">Centralised team spending</h3>
              </div>
              <p class="wow fadeInUp" data-wow-delay="0.1s">Prepaid cards from Paayco empower your team to spend and allow you to budget, monitor transactions, and set limits..</p>
              <div class="btn-grp mt-5">
                <a href="#" title="Order card now" class="btn btn-bright-green wow fadeInUp" data-wow-delay="0.2s"> Order card now </a>
              </div>
            </div>
