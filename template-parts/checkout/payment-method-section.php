...
if (isset($payment_method_section)):
    ?>
    <section class="worldwide-payments" style="background: #ffffff">
        <div class="container">
                            ...
                            <div class="btn-grp">
                                <?php if (!empty($payment_method_section["button_title"])): ?>
                                    <a href="<?php echo @$payment_method_section["button_link"] ?>"
                                       ...
                                       class="btn btn-light-green btn-rd-15"><?php echo $payment_method_section["button_title"] ?></a>
                                <?php endif; ?>
                                <?php if (!empty($payment_method_section["secondary_button_title"])): ?>
                                    <a href="<?php echo $payment_method_section["secondary_button_link"] ?>"
                                       ...
                                       class="btn btn-light-green btn-rd-15"><?php echo $payment_method_section["secondary_button_title"] ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
