                ...
                <div class="col-xxl-10">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-xl-8">
                            ...
                            <h3 class="section-title has-bg-gradient"><?php echo $api_section["title"] ?></h3>
                            ...
                            <div class="btn-grp">
                                <?php if (!empty($api_section["button_title"])): ?>
                                    <a href="<?php echo @$api_section["button_link"] ?>"
                                       ...
                                       class="btn btn-light-green btn-rd-15"><?php echo $api_section["button_title"] ?></a>
                                <?php endif; ?>
                                <?php if (!empty($api_section["secondary_button_title"])): ?>
                                    <a href="<?php echo $api_section["secondary_button_link"] ?>"
                                       ...
                                       class="btn btn-light-green btn-rd-15"><?php echo $api_section["secondary_button_title"] ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
