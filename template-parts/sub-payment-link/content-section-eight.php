<?php
$eighth_content_section = get_field("eighth_content_section");
if ($eighth_content_section) {
    $title = $eighth_content_section["title"];
    $text = $eighth_content_section["text"];
    $primary_button = $eighth_content_section["primary_button"];
    $secondary_button = $eighth_content_section["secondary_button"];
    ?>
    <section class="payment-link-content-section--eight">
                                ...
                                <div class="btn-grp justify-content-center mt-5 pt-md-5">
                                    ...
                                    <?php if ($secondary_button): ?>
                                        <a href="<?php echo $secondary_button["link"] ?>"
                                           ...
                                           class="btn btn-outline-bright-green wow fadeInUp"
