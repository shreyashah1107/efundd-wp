<section class="personal-content-section--five">
  <div class="content-wrapper">
      ...
      <div class="row justify-content-center text-center">
        <div class="col-xl-10 col-xxl-8">
          <div class="title-row position-relative z-1">
            <h3 class="section-title section-title--xl text-anime-style-3">One Account. Unlimited Possibilities.</h3>
    ...
    <div class="globe-img text-center">
      ...
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/redesign/globe-content.png" alt="Image">
