        ...
        <div class="col-xxl-11">
          <div class="row align-items-center justify-content-center justify-content-lg-start">
            <div class="col-lg-7 col-xl-6 text-center text-lg-start mb-5 mb-lg-0">
              ...
              <p>We are a trusted Card Acceptance and Payment Solutions Specialist, offering the latest merchant services and payments technology to a wide range of businesses.</p>
