...
if (isset($cta_section)): ?>
    <!-- Start: Checkout -->
    <section class="checkout checkout--components">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xxl-10">
                    <div class="row align-items-center justify-content-between justify-content-xxl-start">
                        ...
                        <div class="col-lg-6 col-xl-6 col-xxl-6 offset-xxl-1 order-first order-xl-last">
                            <?php if (!empty($cta_section["image"])): ?>
                                <div class="checkout--img text-xl-center">
