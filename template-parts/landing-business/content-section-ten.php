<section class="business-content-section--ten">
  <div class="section-bg section-bg--left">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/redesign/business/section-bg-five.png" alt="Image">
  </div>
          ...
          <div class="row align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="col-lg-7 col-xl-6 text-lg-start mt-5 mt-lg-0">
              <div class="title-row mb-4">
                <h3 class="section-title section-title--xl text-anime-style-3">More than a business account</h3>
              </div>
              ...
              <div class="content-list--items">
                <div class="content-list--item wow fadeInUp" data-wow-delay="0.1s">
                  ...
                  <div class="text">
                    <h4>Accept payments, anywhere</h4>
                    <p>Accept in person and online payments </p>
                  </div>
                </div>
                ...
                <div class="content-list--item wow fadeInUp" data-wow-delay="0.2s">
                  ...
                  <div class="text">
                    <h4>Multiple Currency Account</h4>
                    <p>Get local bank details in 28+ currencies </p>
                  </div>
                </div>
                ...
                <div class="content-list--item wow fadeInUp" data-wow-delay="0.3s">
                  ...
                  <div class="text">
                    ...
                    <p>Manage and assign task to your team members </p>
                  </div>
                </div>
