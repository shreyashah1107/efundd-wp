...
if ($second_content_section) {
    ...
    ?>
    <section class="business-content-section--two">
        <div class="section-bg section-bg--right">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/redesign/business/section-bg-two.png"
                 alt="Image">
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-11">
                        <div class="row align-items-center justify-content-center justify-content-lg-start">
                            <div class="col-md-10 col-lg-6 col-xl-6 order-last order-lg-first">
