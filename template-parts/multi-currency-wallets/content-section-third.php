                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7 col-xl-6 col-xxl-6">
                            ...
                            <div class="btn-grp">
                                ...
                                <?php endif; ?>
                                <?php if (!empty($content_section_third["secondary_button_text"])): ?>
                                    <a href="<?php echo $content_section_third["secondary_button_link"] ?>"
                                       title="<?php echo $content_section_third["secondary_button_text"] ?>"
                                       class="btn btn-light-green"><?php echo $content_section_third["secondary_button_text"] ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
