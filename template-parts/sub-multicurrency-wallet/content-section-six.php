...
if ($sixth_content_section) {
    ...
    ?>
    <section class="multicurrency-wallet-content-section--six">
                        ...
                        <div class="row align-items-center justify-content-center justify-content-lg-start">
                            <div class="col-md-8 col-lg-5 col-xl-6 order-last order-lg-first">
                                <div class="image text-center wow fadeInLeft" data-wow-delay="0.1s">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/redesign/multicurrency-wallet/six.png"
                                         alt="Image">
                                </div>
                            </div>
                            <div class="col-lg-7 col-xl-6 mb-5 mb-lg-0">
                                <div class="title-row mb-5 pb-lg-2">
                                    <h3 class="section-title section-title--xl m-0 text-anime-style-3"><?php echo $title ?></h3>
                                </div>

                                <?php echo $text ?>
                                <?php if ($button): ?>
                                    <div class="btn-grp mt-5 pt-lg-4">
